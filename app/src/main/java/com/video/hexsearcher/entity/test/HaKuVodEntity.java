...
public class HaKuVodEntity extends BaseVodRegexEntity {
    public HaKuVodEntity(){
        ...
        this.setBaseUrl("http://haku77.com");
        this.setSearchUrl("http://haku77.com/index.php?m=vod-search-pg-%page-wd-%keyWords.html");

        this.setResultLinkHeader("http://haku77.com");
        ...
        this.setRuleDetailCoverHeader("http://haku77.com");
